...
public class CefDevToolsClient implements AutoCloseable {
    ...
    CefDevToolsClient(CefBrowser_N browser) {
        ...
        registration_ = browser.addDevToolsMessageObserver(new CefDevToolsMessageObserverAdapter(browser) {
            @Override
            public void onDevToolsMethodResult(
                    CefBrowser browser, int messageId, boolean success, String result, int resultSize) {
