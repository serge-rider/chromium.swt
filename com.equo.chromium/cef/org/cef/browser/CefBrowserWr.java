...
class CefBrowserWr extends CefBrowserSwing {
    ...
    private CefBrowserWr(CefClient client, String url, CefRequestContext context,
        ...
        component_ = new JPanel(new BorderLayout()) {
            ...
            public void setBounds(int x, int y, int width, int height) {
                ...
                wasResized((int) (width * scaleFactor_), (int) (height * scaleFactor_), false);
            }
    ...
    public int getBackgroundColor() {
        ...
        if (Boolean.getBoolean("chromium.inherit_bg_color") && component_.getBackground() != null) {
            color = component_.getBackground();
        } else {
            if (DARK_MODE && !Boolean.getBoolean("chromium.white_bg_color")) {
                return (int) DARK_MODE_COLOR.getColor();
            }
        }
