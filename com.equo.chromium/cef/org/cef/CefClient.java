...
public abstract class CefClient extends CefClientHandler
    ...
    private Runnable disposeAction = null;
    ...
    public void setDisposeAction(Runnable action) {
    ...
    public boolean onBeforeDownload(CefBrowser browser, CefDownloadItem downloadItem,
        ...
        if (downloadHandler_ != null && browser != null)
            return downloadHandler_.onBeforeDownload(browser, downloadItem, suggestedName, callback);
        return false;
    }
